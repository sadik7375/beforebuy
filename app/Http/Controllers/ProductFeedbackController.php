...
class ProductFeedbackController extends Controller
{
    ...
    private function getAppSettings($shopDomain = null)
    {
        $default = [
            ...
            'whatsapp_number' => '',
            'whatsapp_button_text' => 'I have a question',
            'whatsapp_message_template' => 'Hi! I have a question about {product_title}: {product_url}',
            'enable_messenger' => false,
            'messenger_username' => '',
            'messenger_button_text' => 'Chat on Messenger',
            'popup_theme' => 'modern',
    ...
    public function settings(Request $request)
    {
        ...
        return Inertia::render('Settings', [
            ...
            'enable_phone' => (bool)($config['enable_phone'] ?? false),
            'require_phone' => (bool)($config['require_phone'] ?? false),
            'enable_whatsapp' => (bool)($config['enable_whatsapp'] ?? false),
            'whatsapp_number' => $config['whatsapp_number'] ?? '',
            'whatsapp_button_text' => $config['whatsapp_button_text'] ?? 'I have a question',
            'whatsapp_message_template' => $config['whatsapp_message_template'] ?? 'Hi! I have a question about {product_title}: {product_url}',
            'enable_messenger' => (bool)($config['enable_messenger'] ?? false),
            'messenger_username' => $config['messenger_username'] ?? '',
            'messenger_button_text' => $config['messenger_button_text'] ?? 'Chat on Messenger',
    ...
    public function saveSettings(Request $request)
    {
        $validated = $request->validate([
            ...
            'enable_phone' => 'nullable|boolean',
            'require_phone' => 'nullable|boolean',
            'enable_whatsapp' => 'nullable|boolean',
            'whatsapp_number' => 'nullable|string',
            'whatsapp_button_text' => 'nullable|string',
            'whatsapp_message_template' => 'nullable|string',
            'enable_messenger' => 'nullable|boolean',
            'messenger_username' => 'nullable|string',
            'messenger_button_text' => 'nullable|string',
        ...
        $config = [
            ...
            'enable_phone' => (bool)($validated['enable_phone'] ?? false),
            'require_phone' => (bool)($validated['require_phone'] ?? false),
            'enable_whatsapp' => (bool)($validated['enable_whatsapp'] ?? false),
            'whatsapp_number' => trim($validated['whatsapp_number'] ?? ''),
            'whatsapp_button_text' => trim($validated['whatsapp_button_text'] ?? 'I have a question'),
            'whatsapp_message_template' => trim($validated['whatsapp_message_template'] ?? 'Hi! I have a question about {product_title}: {product_url}'),
            'enable_messenger' => (bool)($validated['enable_messenger'] ?? false),
            'messenger_username' => trim($validated['messenger_username'] ?? ''),
            'messenger_button_text' => trim($validated['messenger_button_text'] ?? 'Chat on Messenger'),
    ...
    public function getApiSettings(Request $request)
    {
        ...
        return response()->json([
            ...
            'enable_phone' => $config['enable_phone'] ?? false,
            'require_phone' => $config['require_phone'] ?? false,
            'enable_whatsapp' => $config['enable_whatsapp'] ?? false,
            'whatsapp_number' => $config['whatsapp_number'] ?? '',
            'whatsapp_button_text' => $config['whatsapp_button_text'] ?? 'I have a question',
            'whatsapp_message_template' => $config['whatsapp_message_template'] ?? 'Hi! I have a question about {product_title}: {product_url}',
            'enable_messenger' => $config['enable_messenger'] ?? false,
            'messenger_username' => $config['messenger_username'] ?? '',
            'messenger_button_text' => $config['messenger_button_text'] ?? 'Chat on Messenger',
            'popup_theme' => $config['popup_theme'] ?? 'modern',
            'product_targeting_mode' => $config['product_targeting_mode'] ?? 'all',
