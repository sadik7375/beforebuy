        ...
        <AppLayout>
            <Page fullWidth>
                <BlockStack gap="600">
                    ...
                    {/* Analytics Content Area (Blurred for Free plan) */}
                                    ...
                                    <BlockStack gap="400" inlineAlign="center">
                                        ...
                                        <BlockStack gap="100" inlineAlign="center">
                                            <Text variant="headingLg" as="h2" alignment="center">
                                                Analytics & Objections Locked
                                            </Text>
                                            <Text variant="bodyMd" tone="subdued" alignment="center">
                                                You are currently on the <strong>Free Plan</strong>. Upgrade to <strong>Pro ($5/month)</strong> to unlock full objection breakdown, revenue analytics, and AI reports.
                                            </Text>
                                        </BlockStack>
