...
export default function Overview({ feedbacks = [], stats = {}, plan = 'free', currentPlan = 'free', shopDomain = '', monthlyCount = 0 }) {
                ...
                <BlockStack gap="600">
                    ...
                    <BlockStack gap="600">
                        ...
                        <Grid>
                            ...
                            {/* Right Card: Assist AI Analysis (Locked for Free Plan) */}
                            <Grid.Cell columnSpan={{ xs: 12, sm: 6, md: 6, lg: 6, xl: 6 }}>
                                    ...
                                    {!isPro && (
                                        <div style={{
                                            ...
                                            <BlockStack gap="200" inlineAlign="center">
                                                <Text variant="headingMd" as="h4" weight="bold" alignment="center">
                                                    AI Insights Locked
                                                </Text>
                                                <Text variant="bodySm" tone="subdued" alignment="center">
                                                    Upgrade to Pro ($5/month) to unlock AI Analysis and Automated Insights.
                                                </Text>
                                                <div style={{ marginTop: '8px' }}>
                                                    <Button variant="primary" onClick={handleUpgradeRedirect}>
                                                        Upgrade to Pro ($5/mo)
                                                    </Button>
                                                </div>
                                            </BlockStack>
