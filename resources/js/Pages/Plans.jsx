...
import { Page, BlockStack, Card, Text, Grid, Badge, InlineStack, Banner, Button, List, Divider } from '@shopify/polaris';
                            ...
                            <Grid.Cell columnSpan={{ xs: 12, sm: 6, md: 6, lg: 6, xl: 6 }}>
                                <Card padding="0">
                                    <div style={{
                                        ...
                                        <div style={{ padding: '16px 20px', backgroundColor: '#f6f6f7', borderTop: '1px solid #e1e3e5' }}>
                                            {!isPro ? (
                            ...
                            <Grid.Cell columnSpan={{ xs: 12, sm: 6, md: 6, lg: 6, xl: 6 }}>
                                <Card padding="0">
                                    <div style={{
                                        ...
                                        minHeight: '380px',
                                        borderRadius: '8px',
                                        border: isPro ? '2px solid #008060' : '2px solid #008060',
                                        ...
                                        <div style={{ padding: '16px 20px', backgroundColor: isPro ? '#f6f6f7' : '#f0fdf4', borderTop: '1px solid #e1e3e5' }}>
                                            {isPro ? (
                                                <Button fullWidth disabled>Currently Active</Button>
                                            ) : (
                                                <Button
